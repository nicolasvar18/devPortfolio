						...
						<div className="box-linear-animation position-relative z-1">
							<div className="p-lg-8 p-md-6 p-3 position-relative z-1">
								<div className="d-flex align-items-center">
									...
									<span className="text-linear-4 d-flex align-items-center"> Experiencia </span>
								</div>
								<h3>
									+12
									<span className="text-300">años de </span>
									pasión
								...
								<div className="row mt-5">
											...
											<Link href="#" className="technology border border-1 rounded-3 p-3">
												<div className="d-flex align-items-center gap-2">
													...
													<div className="d-flex flex-column ms-2">
														...
														<span className="text-300">2018 - Presente</span>
													</div>
												</div>
											</Link>
											<Link href="#" className="technology border border-1 rounded-3 p-3">
									...
									<div className="col-lg-8 ps-lg-5 mt-5 mt-lg-0">
										<h6 className="text-linear-4">Ingeniero de Software Senior</h6>
										<ul className="mt-4">
											<li className="text-dark mb-3">Lideré el desarrollo de aplicaciones web escalables, <span className="text-secondary-2">mejorando el rendimiento</span> y la experiencia de usuario para millones de usuarios.</li>
											<li className="text-dark mb-3">Implementé algoritmos de aprendizaje automático para mejorar la funcionalidad de búsqueda.</li>
											<li className="text-dark mb-3">Colaboré con equipos multifuncionales para integrar nuevas características sin problemas.</li>
										</ul>
