											...
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													...
													<div>
														...
														<p className="text-dark">Licenciatura en Ciencias de la Computación</p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													...
													<div>
														<span className="text-primary-2">Universidad de Harvard</span>
														<p className="text-dark">Certificación en React y Redux, Curso de Desarrollo Node.js</p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													...
													<div>
														<span className="text-primary-2">Universidad de Stanford</span>
														<p className="text-dark">Certificación en Desarrollo Web Full Stack</p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													...
													<div>
														<span className="text-primary-2">Universidad de Washington</span>
														<p className="text-dark">Certificación en React y Redux, Curso de Desarrollo Node.js</p>
													</div>
												</div>
											</li>
						...
						<div className="col-lg-6 pt-3">
							<div className="bg-3 rounded-3 border border-1 p-md-6 p-3 position-relative h-100 overflow-hidden">
								<div className="d-flex align-items-center">
									...
									<h2 className="mb-0 ms-2">Investigación</h2>
								</div>
								<div className="d-flex flex-column h-100 position-relative mt-5">
									<ul className="ps-3">
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												...
												<div>
													<span className="text-primary-2">Análisis Avanzado de Datos con Herramientas Big Data</span>
													<p className="text-dark">Utilización de herramientas de big data para análisis avanzado y obtención de insights.</p>
												</div>
											</div>
										</li>
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												...
												<div>
													<span className="text-primary-2">Arquitecturas de Aplicaciones Cloud-Native</span>
													<p className="text-dark">Estudio de mejores prácticas para el diseño de aplicaciones nativas en la nube.</p>
												</div>
											</div>
										</li>
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												...
												<div>
													<span className="text-primary-2">Personalización de Experiencia de Usuario Basada en IA</span>
													<p className="text-dark">Aprovechamiento de IA para personalizar experiencias de usuario basadas en comportamiento.</p>
												</div>
											</div>
										</li>
									</ul>
