				...
				<div className="container position-relative z-3">
					<div className="row">
						<div className="col-lg-6 col-md-12">
							<span className="text-dark">👋 Hola, soy William</span>
							<h1 className="ds-2 mb-3">Creando Experiencias <span className="text-primary-1">Digitales Intuitivas</span></h1>
							<p className="text-300 mb-6">Ayudo a individuos y marcas a alcanzar sus objetivos mediante la creación y desarrollo de productos digitales y experiencias interactivas enfocadas en el usuario.</p>
							...
							<p className="text-400 mt-6 mb-3">+ 12 años con software de diseño profesional</p>
