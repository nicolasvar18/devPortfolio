							...
							<div className="position-relative z-1">
								<div className="text-center">
									<div className="d-flex align-items-center justify-content-center">
										...
										<span className="text-linear-4 d-flex align-items-center"> Cooperación </span>
									</div>
									<h3>
									...
									<div className="row g-4">
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Desarrollo Web y Aplicaciones</h6>
												<p className="fs-7 text-300 fw-regular">Creación de interfaces visualmente atractivas y fáciles de usar con <span className="text-secondary-2">HTML</span>, <span className="text-secondary-2">CSS</span>, <span className="text-secondary-2">JavaScript</span>, y frameworks modernos como React y Angular.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Diseño y gestión de bases de datos con tecnologías SQL y NoSQL como <span className="text-secondary-2">MySQL</span>, <span className="text-secondary-2">PostgreSQL</span>, y <span className="text-secondary-2">MongoDB</span>.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Desarrollo de APIs</h6>
												<p className="fs-7 text-300 fw-regular">Creación e integración de <span className="text-secondary-2">APIs RESTful</span> para permitir una comunicación fluida entre sistemas frontend y backend.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Optimización de Rendimiento</h6>
												<p className="fs-7 text-300 fw-regular">Mejora de la velocidad y rendimiento de aplicaciones web para proporcionar una mejor experiencia de usuario. Trabajo con <span className="text-secondary-2">Nodejs</span>, <span className="text-secondary-2">Express</span></p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<h6 className="my-3 fw-medium">Soluciones E-commerce</h6>
												<p className="fs-7 text-300 fw-regular">Desarrollo de soluciones de pago escalables y seguras para <span className="text-secondary-2">plataformas de comercio electrónico</span> adaptadas a las necesidades de tu negocio.</p>
											</div>
										</div>
										<div className="col-lg-4 col-md-6">
											<div className="card-servies-2 rounded-2 h-100 hover-up">
												...
												<p className="fs-7 text-300 fw-regular">Potencia tus aplicaciones con IA para mejorar la eficiencia, automatización y experiencia del usuario</p>
											</div>
										</div>
									</div>
									<div className="text-center pt-60">
										<p className="text-300">
											Emocionado por emprender <span className="text-dark">nuevos proyectos</span> y colaborar. <br />
											Hablemos sobre tus ideas. <Link href="#" className="text-primary-2">¡Contáctame!</Link>
										</p>
									</div>
								</div>
							</div>
