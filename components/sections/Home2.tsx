										...
										<div className="text-secondary-2 d-flex align-items-center">
											...
											<div className="text-dark">
												<div className="typewriter">
													<h1 className="fs-6 fw-medium">Hola, soy Nicolas</h1>
												</div>
											</div>
											&lt;/span&gt;
										</div>
										<h1 className="fs-50 my-3">Ingeniero de <span className="text-linear-4">{'{'}Software{'}'}</span> <span className="flicker">_</span></h1>
										<p className="mb-6 text-secondary-2">&lt;p&gt;<span className="text-dark">Con experiencia en tecnologías de vanguardia como</span> <span className="text-secondary-2">NodeJS</span>, <span className="text-secondary-2">React</span>, <span className="text-secondary-2">Angular</span>, y <span className="text-secondary-2">Laravel</span><span className="text-dark">... Entrego soluciones web que son innovadoras y robustas.</span>&lt;/p&gt;</p>
										<div className="row">
											<div className="col-7">
												{/* Carausel Scroll */}
