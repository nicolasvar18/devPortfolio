								...
								<div className="col-lg-auto col-md-6 text-center text-lg-start">
									<div className="counter-item-cover counter-item">
										<div className="content mx-auto">
											...
											<p className="fs-6 mb-0 text-dark">Años de Experiencia</p>
										</div>
									</div>
								</div>
								<div className="col-lg-auto col-md-6 text-center text-lg-start">
									<div className="counter-item-cover counter-item">
										<div className="content mx-auto">
											...
											<p className="fs-6 mb-0 text-dark">Proyectos Completados</p>
										</div>
									</div>
								</div>
								<div className="col-lg-auto col-md-6 text-center text-lg-start">
									<div className="counter-item-cover counter-item">
										<div className="content mx-auto">
											...
											<p className="fs-6 mb-0 text-dark">Clientes Satisfechos</p>
										</div>
									</div>
								</div>
								{/* <div className="col-lg-auto col-md-6 text-center text-lg-start">
									<div className="counter-item-cover counter-item">
										<div className="content mx-auto">
											...
											<p className="fs-6 mb-0 text-dark">Premios Ganados</p>
										</div>
									</div>
								</div> */}
							</div>
