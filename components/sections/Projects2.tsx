													...
													<div className="row">
														...
														<div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
															<h4 className="text-linear-4">
																...
																Inventarios Inteligente
															</h4>
															<p>Desarrollé una plataforma de gestión de inventarios con análisis predictivo y automatización de pedidos.</p>
															<ul className="mt-4 list-unstyled">
																<li className="text-secondary-2 mb-3 border-bottom pb-3">Información del Proyecto</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">Cliente</p>
																		<p className="text-300 mb-0 text-end">Distribuidora Nacional SA</p>
																	</div>
																</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">Tiempo de Desarrollo</p>
																		<p className="text-300 mb-0 text-end">4 meses</p>
																	</div>
																</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">Tecnologías</p>
																		<p className="text-300 mb-0 text-end">Python, Django, PostgreSQL, Redis</p>
																	</div>
																</li>
															</ul>
											...
											<SwiperSlide>
												<div className="p-lg-5 p-md-4 p-3 border border-1 mt-5 bg-3">
													<div className="row">
														...
														<div className="col-lg-7 ps-lg-5 mt-5 mt-lg-0">
															<h4 className="text-linear-4">
																Integración de IA 2.0 en el <br />
																sistema de comercio electrónico
															</h4>
															<p>Desarrollé una plataforma de aprendizaje en línea con gestión de cursos, cuestionarios y seguimiento del progreso.</p>
															<ul className="mt-4 list-unstyled">
																<li className="text-secondary-2 mb-3 border-bottom pb-3">Información del Proyecto</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																...
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
																		<p className="text-dark mb-0 text-end">Tiempo de Finalización</p>
																		<p className="text-300 mb-0 text-end">6 meses</p>
																	</div>
																</li>
																<li className="text-dark mb-3 border-bottom pb-3">
																	<div className="d-flex justify-content-between">
